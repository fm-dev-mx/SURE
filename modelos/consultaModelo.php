 <?php
	...
	class consultaModelo extends mainModel{
		...
		protected function agregar_consulta_modelo($datos){
		...
		protected function eliminar_consulta_modelo($codigo){
		...
		protected function datos_consulta_modelo($tipo,$codigo){
			if($tipo=="Unico"){
		...
		protected function actualizar_consulta_modelo($datos){
