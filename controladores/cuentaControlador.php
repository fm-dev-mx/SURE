		...
		public function actualizar_cuenta_controlador(){
			...
			if($user!="" && $password!=""){
				...
				$alerta=[
					"Alerta"=>"simple",
					"Titulo"=>"Ocurrió un error inesperado",
					"Texto"=>"Para actualizar los datos de la cuenta debe de ingresar su nombre de usuario y contraseña, por favor ingrese los datos e intente nuevamente",
					"Tipo"=>"error"
				];
				return mainModel::sweet_alert($alerta);
				exit();
